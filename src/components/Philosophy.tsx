      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            <span className="inline-block text-[10px] uppercase tracking-[0.3em] text-primary font-mono font-medium mb-6">{t.philosophy.eyebrow}</span>
            <h2 className="font-display text-section mb-14 leading-[1.15] text-white">
              {t.philosophy.title1}{" "}
              <span className="gradient-text-hero">{t.philosophy.titleAccent}</span>
            </h2>
          </div>

          <div className="max-w-2xl mx-auto mb-14">
            <div className="featured-image-frame">
              <img src={bgAiLab} alt="AI" className="w-full h-auto object-cover" loading="lazy" />
          ...
          <div className="space-y-8 mb-16 text-center">
            {t.philosophy.thoughts.map((th, i) => (
