  ...
  return (
    <section id="riesenia" className="relative py-28 md:py-36">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-[hsl(200_100%_55%/0.03)] rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] bg-[hsl(260_70%_60%/0.03)] rounded-full blur-[100px]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[hsl(195_100%_62%/0.02)] rounded-full blur-[140px]" />
      </div>
            ...
            >
              <div className="gradient-border-card group h-full">
                <div className="gradient-border-inner p-7 lg:p-8 h-full relative overflow-hidden">
                  {/* Ambient inner glow */}
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[hsl(var(--glow-primary)/0.04)] rounded-full blur-[60px] pointer-events-none" />
