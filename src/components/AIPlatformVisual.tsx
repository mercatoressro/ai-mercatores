    ...
    <div className="relative w-full h-full min-h-[500px] lg:min-h-[600px]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[55%] z-20">
        <div className="relative">
          <div className="absolute -inset-4 rounded-2xl bg-[hsl(200_100%_55%/0.08)] blur-xl animate-pulse" />
      ...
      <div className="absolute top-[42%] left-[-3%] z-10">
      ...
      <div className="absolute top-[48%] right-[-2%] z-10">
          ...
          <div className="mt-2 flex gap-1">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="flex-1 h-0.5 rounded-full bg-primary/30">
                <div className="h-full rounded-full bg-primary/70 w-full" />
              </div>
            ))}
          </div>
        </div>
